...
Main.prototype.generateApp = function () {
    ...
    var files = [],
        hierarchy = $('<p id="jk-hierarchy"></p>'),
        decorationService = new DecorationService(hierarchy),
        hierarchyGenerator = new HierarchyGeneratorService(),
        appInteractionService = new AppInteractionService(this.toolBarHeight, this.hotKeysService, this);
